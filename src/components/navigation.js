      ...
      <header data-thq="thq-navbar" className="navigation-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navigation-desktop-menu">
          <nav className="navigation-links">
            <Link to="/" className="navigation-home nav-menu-point">
              Home
            </Link>
            <Link to="/team" className="navigation-team nav-menu-point">
              Unser Team
            </Link>
            ...
            >
              ...
              >
                <span className="navigation-text nav-menu-point">Kontakt</span>
                <div
        ...
        <div data-thq="thq-mobile-menu" className="navigation-mobile-menu">
          <div className="navigation-nav">
            <div className="navigation-top">
              ...
              />
              <div data-thq="thq-close-menu" className="navigation-close-menu">
