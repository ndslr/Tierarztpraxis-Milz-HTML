        ...
        <header data-thq="thq-navbar" className="navigation-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navigation-desktop-menu">
            <nav className="navigation-links">
              <Link href="/">
                <a className="nav-menu-point">Home</a>
              </Link>
              <div
              ...
              <span className="nav-menu-point">Leistungen</span>
              <span className="nav-menu-point">Physiotherapie</span>
              <span className="nav-menu-point">Im Notfall</span>
              <div
                data-thq="thq-dropdown"
                className="navigation-thq-dropdown1 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                ...
                >
                  ...
                  <div
                    data-thq="thq-dropdown-arrow"
                    className="navigation-dropdown-arrow1"
                  >
                ...
                <ul
                  data-thq="thq-dropdown-list"
                  className="navigation-dropdown-list1"
                >
                  <li
                    data-thq="thq-dropdown"
                  ...
                  >
                    <div
                      data-thq="thq-dropdown-toggle"
                      className="navigation-dropdown-toggle3"
                    >
                      <span className="navigation-text3 nav-menu-point">
          ...
          <div data-thq="thq-mobile-menu" className="navigation-mobile-menu">
            <div className="navigation-nav">
              <div className="navigation-top">
                ...
                >
                  <svg viewBox="0 0 1024 1024" className="navigation-icon06">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="navigation-links1">
                <span className="navigation-text4">About</span>
                <span className="navigation-text5">Features</span>
                <span className="navigation-text6">Pricing</span>
                <span className="navigation-text7">Team</span>
                <span className="navigation-text8">Blog</span>
              </nav>
